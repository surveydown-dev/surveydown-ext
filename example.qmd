...
# Before deploying on shinyapps.io, please create an .Renviron file and add:
# "SUPABASE_PASSWORD=your_password"
# .gitignore has included .Renviron, so it won't be pushed to GitHub.

# To deploy to shinyapps.io, run:
# rsconnect::deployDoc("your_survey.qmd")

# To deploy and specify a different name for your survey page, run:
# rsconnect::deployDoc(
#   doc = "your_survey.qmd",
...
# The sd_server function initiates your survey
